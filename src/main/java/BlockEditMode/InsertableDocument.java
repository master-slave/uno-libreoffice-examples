...
public class InsertableDocument {
    ...
    public static void main(String[] args) {
        InsertableDocument textDocuments1 = new InsertableDocument();
        try {
    ...
    private void editingExample() throws Exception {
        ...
        textDocument = null;
        textDocument = UnoRuntime.queryInterface(
                XTextDocument.class, xEmptyWriterComponent);

        // get a reference to the body text of the document
        mxDocText = null;
        mxDocText = textDocument.getText();
    ...
    private void viewCursorExample() throws Exception {
        ...
        XDocumentInsertable insertable = (XDocumentInsertable) UnoRuntime.queryInterface(XDocumentInsertable.class, xModelCursor);
